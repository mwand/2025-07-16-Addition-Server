  ...
  describe('Health Check Endpoints', () => {
    ...
    describe('Addition Endpoint', () => {
      ...
      it('should call getSum controller for /sum/:i/:j route', async () => {
        ...
        request(app);
        const response = await request(app).get('/sum/2/3').expect(200);
      ...
      it('should handle controller errors gracefully', async () => {
        ...
        const response = await request(app).get('/sum/1/2').expect(500);
      ...
      it('should handle invalid parameters through controller', async () => {
        ...
        const response = await request(app).get('/sum/abc/def').expect(400);
    ...
    describe('Error Handling', () => {
      ...
      it('should return 404 for unsupported HTTP methods', async () => {
        const response = await request(app).post('/sum/1/2').expect(404);
